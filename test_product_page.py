...
# Здесь 1 тест помечен как xfail. Тест специально оставил с "параметризацией". Промо страница только с 6 по 9
@pytest.mark.need_review
...
@pytest.mark.skip  # падающий тест, для обучения отрицательным проверкам
